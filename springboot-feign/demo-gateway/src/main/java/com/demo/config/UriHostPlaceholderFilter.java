...
public class UriHostPlaceholderFilter extends AbstractGatewayFilterFactory<UriHostPlaceholderFilter.Config> {
    ...
    public GatewayFilter apply(Config config) {
        return new OrderedGatewayFilter((exchange, chain) -> {
            ...
            if(!type.equals("")){
                newurl = "http://192.168.142.177:2183/geoserver/gwc/service/wmts?layer=ellip%3Alangfang_img_c_1_16_big&style=&tilematrixset=EPSG%3A4326&Service=WMTS&Request=GetTile&Version=1.0.0&Format=image%2Fpng&TileMatrix=EPSG%3A4326%3A8&TileCol=420&TileRow=71";
            }
            if (!newurl.equals("")) {
